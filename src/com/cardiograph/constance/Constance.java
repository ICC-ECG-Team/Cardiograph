...
public class Constance
{
	...
	public static String URL_UPLOAD = "http://ecg.flymx.net/m";
	public static String URL_LOGIN = "http://ecg.flymx.net/m";
	public static String URL_UPDATE = "http://ecg.flymx.net/m";
